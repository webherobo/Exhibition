...
class UserModel extends RelationModel {
    ...
    protected $fields = array('id', 'username', 'email', 'password', 'update_time', 'create_time');
    ...
    protected $_validate = array(
        ...
        /* 验证密码 */
       // array('password', '', 2, 'ignore'), //密码为空更新忽略
        array('password', '1,30', -4, self::EXISTS_VALIDATE, 'length'), //密码长度不合法
        /* 验证邮箱 */
    ...
    public function userlist($currentpage) {
        ...
        $userlist = $this->order('id asc')->page($currentpage != "" ? $currentpage : 1, 3)->select();
        return $userlist;
    }
