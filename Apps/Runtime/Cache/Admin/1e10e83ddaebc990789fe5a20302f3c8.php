                    ...
                    <li>
                        ...
                        <div class="col-md-10 panel panel-default" >
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" action="/Exhibition/admin.php?m=Admin&c=User&a=editrole&id=1" method="post">
                                    <div class="form-group">
                                        <label for="firstname" class="col-sm-2 control-label">角色组</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="firstname" disabled
                                                   placeholder="请选择角色组" name="pid"  value="<?php echo ($role['pid']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="firstname" 
                                                   placeholder="请输入角色名称" name="rolename"  value="<?php echo ($role['name']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <div class="checkbox">
                                                <label>
                                                    <input  type="checkbox" <?php if($role['status'] == 'on' ): ?>checked="checked"<?php else: endif; ?> name="status" > 启用
                                                </label>
                                            </div>
                                        </div>
                                    </div>
