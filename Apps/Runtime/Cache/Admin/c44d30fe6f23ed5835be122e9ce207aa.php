        ...
        关于系统
                        ...
                        <div class="col-md-10 panel panel-default" >
                            <div class="panel-body">
                                <table class="table">
                                    <caption>角色基本信息<a class="btn btn-primary" href="<?php echo U('User/addrole');?>">新增角色</a> </caption>
                                    <thead>
                                        <tr>
                                            <th>角色Id</th>
                                            <th>组id</th>
                                    ...
                                    <tbody>
                                        <?php if(is_array($rolelist)): foreach($rolelist as $key=>$vo): ?><tr>
                                                ...
                                                <td><a href="<?php echo U('User/editrole',array('id'=>$vo['id']));?>">编辑</a>   |  <a href="<?php echo U('User/deleterole',array('id'=>$vo['id']));?>">删除</a></td>
