                    ...
                    <li>
                        ...
                        <div class="col-md-10 panel panel-default" >
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" role="form" action="/Exhibition/admin.php?m=Admin&c=User&a=editer&id=4" method="post">
                                    <div class="form-group">
                                        <label for="firstname" class="col-sm-2 control-label">名字</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="firstname" 
                                                   placeholder="请输入名字" name="username"  value="<?php echo ($userinfo['username']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
